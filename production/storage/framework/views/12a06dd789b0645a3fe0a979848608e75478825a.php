    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 xs-padding-right-15">
                <?php if(isset($helpPage->post_status->status_title) and $helpPage->post_status->status_title == 'published'): ?>
                <a href="<?php echo e(url($helpPage->slug)); ?>" style="display: inline-block;    clear: none;" class="default-btn pull-right action_button lg-button">
                    Help
                </a>
                <?php endif; ?>
                    <?php if(isset($rulesPage->post_status->status_title) and $rulesPage->post_status->status_title == 'published'): ?>

                    <a href="<?php echo e(url($rulesPage->slug)); ?>" style="display: inline-block;     clear: none; margin-right: 10px" class="default-btn pull-right action_button lg-button">
                    Rules
                </a>
                    <?php endif; ?>
            ...
            <section class="welcome-wrap padding-top-30 sm-horizontal-15">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none sm-padding-left-none md-padding-left-15 xs-padding-left-none padding-bottom-40 scroll_effect fadeInUp" data-wow-delay='.2s' style="z-index:100">
                        ...
                        <?php echo $__env->make('home.searchForm', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <!--invetory ends-->
                </div>
                <div class="row parallax_parent design_2 margin-bottom-40 margin-top-30">
                    <div class="parallax_scroll clearfix" data-velocity="-.5" data-offset="-200" data-image="<?php echo e(asset('images/1.jpg')); ?>">
                        <div class="overlay">
                            <div class="container">
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                                <div class="flip margin-bottom-30">
                                    <div class="card">
                                        <div class="face front"><img class="img-responsive" src="<?php echo e(asset('images/car1.jpg')); ?>" alt=""></div>
                                        <div class="face back">
                                            <div class='hover_title'>Race Ready</div>
                                            <a href="#."><i class="fa fa-link button_icon"></i></a> <a href="<?php echo e(asset('images/car1.jpg')); ?>" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                                <div class="flip horizontal margin-bottom-30">
                                    <div class="card">
                                        <div class="face front"><img class="img-responsive" src="<?php echo e(asset('images/car2.jpg')); ?>" alt=""></div>
                                        <div class="face back">
                                            <div class='hover_title'>Family Oriented</div>
                                            <a href="#."><i class="fa fa-link button_icon"></i></a> <a href="<?php echo e(asset('images/car2.jpg')); ?>" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                                <div class="flip margin-bottom-30">
                                    <div class="card">
                                        <div class="face front"><img class="img-responsive" src="<?php echo e(asset('images/car3.jpg')); ?>" alt=""></div>
                                        <div class="face back">
                                            <div class='hover_title'>World Class</div>
                                            <a href="#."><i class="fa fa-link button_icon"></i></a> <a href="<?php echo e(asset('images/car3.jpg')); ?>" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                                    </div>
                                </div>
