<div class="search-form margin-top-20 padding-vertical-20">
    <form  action="#">
        <div class="select-wrapper clearfix">
            <div class="col-md-6">
                <div class="my-dropdown ake-dropdown">
                    <?php echo e(Form::select('year', $manufacturing_years, Request::input('year'),
            ...
            <div class="col-md-6">
                <div class="my-dropdown ake-dropdown">
                    <?php echo e(Form::select('company', $companies, Request::input('company'),
        ...
        <div class="select-wrapper clearfix">
            <div class="col-md-6">
                <div class="my-dropdown make-dropdown">
                    <?php echo e(Form::select('model', $models, Request::input('model'),
       ['class' => 'css-dropdowns', 'tabindex' => 1, 'placeholder' => 'All Models'])); ?>
            ...
            <div class="col-md-6">
                    <div class="my-dropdown make-dropdown">
                        <?php echo e(Form::select('body_type', $body_types, Request::input('body_type'),
        ...
        <div class="select-wrapper clearfix">
            <div class="col-md-6">
                <div class="my-dropdown make-dropdown">
                    <?php echo e(Form::select('kilometer', $kilometers, Request::input('kilometer'),
            ...
            <div class="col-md-6">
                    <div class="my-dropdown make-dropdown">
                        <?php echo e(Form::select('transmission', ['automatic' => 'Automatic', 'manual'=> 'Manual'], Request::input('transmission'),
        ...
        <div class="select-wrapper clearfix">
            <div class="col-md-6">
                <div class="my-dropdown make-dropdown">
                    <?php echo e(Form::select('location', $city_of_registration, Request::input('location'),
          ['class' => 'css-dropdowns', 'tabindex' => 1, 'placeholder' => 'All Locations'])); ?>
            ...
            <div class="col-md-6">
                    <div class="my-dropdown make-dropdown">
                        <?php echo e(Form::select('price', $bid_starting_amounts, Request::input('price'),
