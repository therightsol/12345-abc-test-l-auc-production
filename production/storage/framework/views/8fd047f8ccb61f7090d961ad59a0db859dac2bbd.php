                        ...
                        <div class="slide">
                            <div class="car-block">
                                <div class="img-flex"> <a href="#"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a>
                                    <img
                                            src="<?php echo e(isset($auctions[$x]->car->meta[0]) ? asset($auctions[$x]->car->meta[0]->meta_value) : asset('images/image-not-found-100x100.png')); ?>"  alt="" class="img-responsive">
                                </div>
                                <div class="car-block-bottom">
                                    <h6><strong><?php echo e($auctions[$x]->car->title); ?></strong></h6>
                                    <h6><?php echo e($auctions[$x]->car->kilometers); ?> kilometers</h6>
                                    <h5><?php echo e(Helper::currencySymbol()); ?> <?php echo e($auctions[$x]->bid_starting_amount); ?></h5>
                                </div>
                            </div>
                        </div>
                        <?php endfor; ?>
